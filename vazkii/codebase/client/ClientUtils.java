...
public class ClientUtils {
    ...
    public static Entity getEntityLookedAt(float renderTick)
    {
        ...
        {
                final double finalDistance = (double)HealthBarsConfig.maxRenderDistance;
                ...
                List<Entity> entitiesInBoundingBox = mc.theWorld.getEntitiesWithinAABBExcludingEntity(mc.renderViewEntity, mc.renderViewEntity.boundingBox.addCoord(lookVector.xCoord * finalDistance, lookVector.yCoord * finalDistance, lookVector.zCoord * finalDistance).expand((double)1.0F, (double)1.0F, (double)1.0F));
                ...
                for (Entity entity : entitiesInBoundingBox)
                {
                    if (entity.canBeCollidedWith())
                    {
                        ...
                        AxisAlignedBB hitbox = entity.boundingBox.expand((double)collisionBorderSize, (double)collisionBorderSize, (double)collisionBorderSize);
                ...
                if (lookedEntity != null && (minDistance < distance || mc.objectMouseOver == null))
